  ...
  const userMedia = [
    ...
    return(
        <>
            ...
            ================================================= --> */}
            <div class="media">
            	<Row class="js-masonry" data-masonry='{ "itemSelector": ".grid-item", "columnWidth": ".grid-sizer", "percentPosition": true }'>
              {userMedia.map((data) => {
            return (
              <Fragment key={nanoid()}>
                <Col md={6} sm={6} className="grid-item">
                  <div className="media-grid">
                    ...
                    >
											...
											<video controls>
												<source src={data.gridVideo} type="video/mp4"/>
											</video>
...
export default NewsFeedUserMedia